  ...
  return (
    <>
      <div className="hidden sticky top-20 shadow-xl w-[500px] lg:w-[700px] h-max mt-5 rounded-xl p-5 lg:flex flex-col items-stretch gap-5">
        <h1 className="text-center font-bold text-[#E04132] text-3xl">
          Your Orders
        </h1>
      ...
      <div className="lg:hidden w-[290px] flex flex-col justify-center items-center shadow-xl rounded-xl gap-5 p-5">
        ...
        {cart.map((item) => {
          return (
            <div
              className="grid grid-cols-3 text-xs justify-self-center p-1 text-center w-full"
              key={item._id}
            >
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <span className="text-2xl font-semibold text-[#E04132]">
            {formatNumber(totalAmount)}
          </span>
        </div>
      </div>
