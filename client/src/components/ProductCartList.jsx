  ...
  return (
    <div>
      {cart.map((item, index) => {
        return (
          <div
            className="relative shadow-xl flex flex-col gap-5 lg:gap-0 lg:flex-row justify-center lg:w-[40vw] mt-5 rounded-xl p-3 lg:p-6"
            key={item._id}
          >
            ...
            <div className="w-full pl-8 flex flex-col justify-center gap-2">
              ...
              <p className="text-gray-500 font-light">
                ...
                <span className="text-gray-500 font-light">per piece</span>
              </p>
              <p className="text-gray-500 font-light">
                Qty:{" "}
